...
namespace StudentFinanaceBudgetingAssisatant
{
    public partial class Config : Form
    {
        ...
        public void StoreConfig()
        {
            ...
            {
                YearRecords.RemoveAt((int)NUYear.Value - 1);
                YearRecords.Insert((int)NUYear.Value - 1, YI);
                BtnSaveConfig.Text = "BtnSaveConfig";
            }
            else { YearRecords.Add(YI); }   //PoulateEmpty | append
